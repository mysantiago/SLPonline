...
?>
  ...
  <div class="col-md-6" style="padding:1em;padding-top:0;">
    <div style="border:solid 1px #c5d6de;margin-left:1em;background:#fff;text-align:center;padding:0;">
      asdf
    </div>
  </div>
  <div class="col-md-3" style="padding:1em;padding-top:0;">

    <div class="row">
      <div style="border:solid 1px #29a0fb;margin-left:1em;background:#48b0ff;text-align:center;padding:0;border-radius:5px">
        <b style="color:#fff">Human Resources</b><br>
        <h3 style="margin-bottom:0;margin-top:0;display:inline-block" id="hr2"></h3> / <h3 style="margin-bottom:0;margin-top:0;display:inline-block" id="hr1"></h3><br>
        <span style="color:#fff">confirmed accounts</span>
      </div>
    </div>

    <div class="row" style="margin-top:1em">
      <div style="border:solid 1px #fcad04;margin-left:1em;background:#FFFFBA;text-align:center;padding:0;border-radius:5px">
        <b style="color:#fff">HanapBuhay</b><br>
        <h3 style="margin-bottom:0;margin-top:0;display:inline-block" id="hr2"></h3> / <h3 style="margin-bottom:0;margin-top:0;display:inline-block" id="hr1"></h3><br>
        <span style="color:#fff">demand supply</span><br>
        3<br>
        <span style="color:#fff">matched</span><br>
      </div>
    </div>

    <div class="row" style="margin-top:1em">
      <div style="border:solid 1px #ef474a;margin-left:1em;background:#f35f62;text-align:center;padding:0;border-radius:5px">
        <b style="color:#fff">E-Library</b><br>
        <h3 style="margin-bottom:0;margin-top:0" id="vc1"></h3>
        <span style="color:#fff">files uploaded</span>
      </div>
    </div>
