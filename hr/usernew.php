...
<div class="row" style="margin:0;padding:0;margin-left:1em;margin-right:1em;border:solid 1px #c5d6de;background:#fff;text-align:center;padding:0">
        <div class="col-md-3 wellz" style="padding:1em">
          ...
          <?php if ($row['nickname'] != "") {
            echo '('.$row['nickname'].')<br>'.$row['firstname'].' '.$row['middlename'].' '.$row['lastname'];
          } else {
            echo $row['firstname'].' '.$row['middlename'].' '.$row['lastname'];
          } ?>
          </span>
          <br>
          <span style="font-size:16px;color:#888"><?php echo $row['designation'];?><br>
            ...
            <button type="button" class="btn btn-info dropdown-toggle btn-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Actions <span class="caret"></span>
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a href="#" style="color:#000"><span class="glyphicon glyphicon-cog"></span> &nbsp;Edit Profile</a></li>
                    <li><a href="#" style="color:#000"><span class="glyphicon glyphicon-warning-sign"></span> &nbsp;Delete Account</a></li>
                    <li><a href="#" style="color:#000"><span class="glyphicon glyphicon-arrow-up"></span> &nbsp;Level up</a></li>
                    <li><a href="#" style="color:#000"><span class="glyphicon glyphicon-eye-open"></span> &nbsp;Reset Password</a></li>
                    <li><a href="#" style="color:#000"><span class="glyphicon glyphicon-eye-open"></span> &nbsp;Resend Confirm</a></li>
                </ul>
          </div>
        </div>
        ...
        <div class="col-md-5 wellz" style="padding:1em;text-align:left;border-right:1px solid #ccc">
            <span style="color:#ccc;font-size:18px"><span id="feelingstat"><?php if ($row['feeling']!="") { echo $row['feeling']; } else { if ($_SESSION['id']==$_GET['id']) { echo "How are you feeling, ".$row['firstname']."? &nbsp;"; } } ?></span>
...
?>
        ...
        <div class="col-md-4 wellz" style="padding:1em;">
          <b style="font-size:20px">Message Wall</b>
          <table style="margin:1em;width:90%">            
<?php
      $stmtcom = $db->prepare("SELECT t.firstname, m.wall_msg, m.wallposted, t.region, t.id FROM wallposts m LEFT JOIN HRDB t ON m.wallposter=t.id ORDER BY m.wallpostid DESC LIMIT 10");
      $stmtcom->execute();
