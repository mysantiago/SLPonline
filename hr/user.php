      ...
      echo "Error: " . $e->getMessage();
          ...
          <hr style="height:1px;border:none;color:#333;background-color:#333; margin-right:-30px; margin-left:-30px"/>
              ...
              <table style="width:100%" id="userdetails" style="border:2px solid red;">
                 <br/>
                <tr style=""><td style="font-size:14px"><b>Email: </b></td><td style="font-size:14px"><?php echo $row['emailaddress'];?></td></tr>
                <tr><td style="font-size:14px"><b>Contact: </b></td><td style="font-size:14px"><?php echo $row['contactnumber'];?></td></tr>
                <tr><td style="font-size:14px"><b>Start Date: </b></td><td style="font-size:14px"><?php echo $row['employdate'];?></td></tr>
               
                <?php if ($_SESSION['permlvl']>0) { ?>
                <tr style="color:#d9534f;font-size:14px"><td><b>Status: </b></td><td style="font-size:14px"><?php echo $row['employstatus'];?></td></tr>
