    ...
    <div class="col-md-12" style="">
      <div style="background:#fff;margin-bottom:1em;padding:1.2em;" class="col-md-12">
        ...
        <div class="col-md-2" style="background:#fff;"><center>
          ...
          $byte = $db->prepare("SELECT SUM(amt) as total FROM bytez m WHERE m.hrdbid='".$_SESSION['id']."' ");
          $byte->execute();
          $bytez = $byte->fetch();
          ?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content" style="padding:1em;padding-top:0">
        ...
        <div class="col-md-8" style="background:#fff;">
          <b><font size="3"><?php if ($row['nickname'] != "") { echo $row['firstname'].' '.$row['middlename'].' '.$row['lastname'].' ('.$row['nickname'].')'; } else { echo $row['firstname'].' '.$row['lastname']; } ?></font></b>
          <br>
