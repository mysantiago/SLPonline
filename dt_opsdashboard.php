...
class TableData {
	...
	public function get($table, $index_column, $columns) {
		...
		$sQuery = "SELECT * FROM opsdashboard";
...
// Get the data
$table_data->get('opsdashboard', 'dashboardid', array('region', 'physical_targets', 'fin_alloc','projects','participants','cost', '', '', '', '', '', '', 'track','asof', 'dashboardid'));
/*
