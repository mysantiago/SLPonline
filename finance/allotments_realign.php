          ...
          <div style="border:solid 1px #c5d6de;background:#fff;text-align:left;padding:0em;padding-left:1em;margin-bottom:2em;width:100%">
              ...
              <div class="row" style="height:100%">
                ...
                <div class="col-md-6" style="padding:3em;color:#000;padding-top:1em">
                  <div class="well">Item: <b>3200123123</b><br>
                  Type: <b>Admin Cost - Travelling Expense</b><br>
                  Original Amount: <b>322,185.00</b></div>
                  Realign allotment to:<br><br>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-md-6">
                        <input class="form-control" placeholder="Realign Amount (PhP)"></input>
                      </div>
                      <div class="col-md-6">
