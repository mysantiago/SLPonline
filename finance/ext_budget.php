          ...
          <div style="border:solid 1px #c5d6de;background:#fff;text-align:left;padding:0em;padding-left:1em;margin-bottom:2em;width:100%">
              ...
              <div class="row" style="height:100%">
                ...
                <div class="col-md-6" style="padding:3em;color:#000;padding-top:1em">
                  <h3>Budget Officer</h3>
                  Please complete the form below:<br><br>
                  <div class="form-group">
                    <input class="form-control" placeholder="Sub-Aro">
                  </div>
                  <div class="form-group">
                    <input class="form-control" placeholder="OBR#">
                  </div>
                  <div class="form-group">
                    <input class="form-control" placeholder="Amount in Php">
                  </div>
                  <div class="form-group">
                    <input class="form-control" placeholder="Date Filed">
                  </div>
                  <div class="form-group">
