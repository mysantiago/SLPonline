                                  ...
                                  <div class="form-group">
                                              <div class="col-sm-12">
                                                <div class="input-group" style="margin-bottom:0">
                                                  <span class="input-group-addon" id="tooltip1" data-original-title="Shared Area" data-content="To make this partner available to other regions" rel="popover" data-placement="top" data-trigger="hover" style="font-size:12px;margin-bottom:0">
                                                    <span style="font-size:16px">Shared Area 1</span> <span class="glyphicon glyphicon-info-sign"></span>
                                                  </span>
                          ...
                          <div id="newinput" style="display:block" class="form-group"></div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-6" style="text-align:right;margin-bottom:2em;margin-top:5px">
                                ...
                                <a href="register.php"><button id="formsubmit" class="col-md-offset-1 btn btn-success col-md-9" data-text="Hooray!">Register</button></a>
                              </div>
                            </div>
                </div>
    </div>
...
function addForm() {
  ...
  newdiv.innerHTML = '<div class="col-sm-12">'+
                                                '<div class="input-group" style="margin-bottom:0">'+
                                                  '<span class="input-group-addon" id="tooltip1" data-original-title="Shared Area" data-content="To make this partner available to other regions" rel="popover" data-placement="top" data-trigger="hover" style="font-size:12px;margin-bottom:0">'+
                                                   ' <span style="font-size:16px">Shared Area '+prefloc+'</span> <span class="glyphicon glyphicon-info-sign"></span>'+
                                                  '</span>'+
