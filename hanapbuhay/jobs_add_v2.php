...
function intervent() {
  ...
  if (intervent == "Training" || intervent == "Placement") {
      $('#indirectpartner').prop("disabled", false);
  }
  if (intervent == "Direct Employment") {
      $('#indirectpartner').prop("disabled", true);
  }
}
</script>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-6" id="indirectholder" style="">
                                    <input type="text" name="indirectpartner" id="indirectpartner" class="form-control" placeholder="Indirect Partner Name" disabled>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="col-sm-12">
                  ...
                  <div class="form-group">
                    <div class="col-md-6">
                      <div class="col-sm-12" style="color:red;text-align:left;padding-left:0">
                        <button class="btn btn-info" id="addsharedloc">Add Alternate Location</button>
                      </div>
                    </div>
                    <div class="col-md-2">
...
function addForm() {
  ...
  newdiv.innerHTML = '<div class="input-group">'+
                                '<span class="input-group-addon">Alternate '+prefloc+'</span>'+
                            ...
                            '<div class="input-group">'+
                                '<span class="input-group-addon">Alternate '+prefloc+'</span>'+
                                '<select class="form-control" id="prov'+prefloc+'" name="prov'+prefloc+'" required onchange="getProv(this.value)"><option value="w" selected>Select City/Municipality</option></select>'+
                            '</div>'
