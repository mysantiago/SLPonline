  ...
  <div class="col-md-9" style="padding:1em;padding-top:0;">
      ...
      <div class="col-md-6" style="padding:0">
        <div class="dashpanel">
          ...
          <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover hover" id="viewdata" style="background-color:#fff;width:100%;margin-bottom:0">
                    <thead style="background:#f6f8fa">
                      <tr>
                        <th></th>
...
//oTable.fnFilter("3", 3, true, false, true);
