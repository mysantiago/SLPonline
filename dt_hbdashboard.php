...
$_SESSION['discard_after'] = $now + 1800;
	...
	public function get($table, $index_column, $columns) {
		...
		$sQuery = "SELECT m.regid, m.regname, COUNT(DISTINCT k.id) as partners, COUNT(DISTINCT n.id) as jobs, SUM(DISTINCT n.numopenings) as openings, COUNT(DISTINCT z.id) as participants,
...
// Get the data
$table_data->get('lib_regions', 'regid', array('regid', 'regname', 'partners','jobs','openings','participants', 'firstname', 'lastname'));
/*
