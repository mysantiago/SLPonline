...
// Get the data
$table_data->get('monicadb', 'id', array('province','MD','EF','SEAK','SCF','MFI','NGALGU','PHYASS','PEAF','ST','CBLA','SCF_AMT','MFI_AMT','NGALUG_AMT','PHYASS_AMT'));
/*
