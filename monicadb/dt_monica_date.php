...
// Get the data
$table_data->get('monicadb', 'id', array('date','seak','seak_amt','scf','scf_grant','mfi','ngalgu','peaf','st','cbla','row_number'));
/*
