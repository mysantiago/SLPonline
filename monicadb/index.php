<?php
require "../zxcd9.php";
byteMe($_SESSION['id'],'mdb_date',0.10);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>SLP | Monica</title>
  ...
  <div class="col-md-12" style="">
      <div style="background:#fff;margin-bottom:1em;padding:1.2em;" class="col-md-12">
          <div class="col-md-12" id="contentblock">
                  ...
                  <span style="color:red">Currently only contains data for region CARAGA</span> - Find out more about Historical Data <a href="aboutmonica.php" style="color:blue;text-decoration:underline">here</a>
